    ...
    <main>
      <Hero backgroundURL={'/src/assets/bg-episodes.jpg'}>
        <p>
          ...
          del tiempo, el espacio y dimensiones desconocidas. Descubre los
          secretos ocultos, las referencias y los detalles que hacen de Rick and
          Morty una experiencia única. ¡Prepárate para un maratón de episodios
